package br.ufpa.facomp.jsf.web.util;
...
public final class JSFUtil {
	...
	private static final String MSG_LOGIN_INVALIDO = "Usuário ou senha incorretos";
	private static final String MSG_UPLOAD_SUCESSO = "Envio realizado com sucesso";

	// private static final String MSG_NENHUM_REGISTRO_ENCONTRADO =
	...
	public void adicionarMsgGlobalOperacaoSucesso() {
		setInfo(MSG_SUCESSO);
	}
	...
	public static void adicionarMsgGlobalUploadSucesso() {
		setInfo(MSG_UPLOAD_SUCESSO);
	}

	public static void adicionarMsgGlobalLoginInvalido() {
		setAviso(MSG_LOGIN_INVALIDO);
	}
